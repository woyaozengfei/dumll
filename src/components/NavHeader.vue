      ...
      <svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="navbar">
          <div class="navbar-left-container">
            <a href="/">
              <img class="navbar-brand-logo" src="/static/duMall2.png">
            </a>
          </div>
          <div class="navbar-right-container" style="display: flex;">
            <div class="navbar-menu-container">
              <span class="navbar-link" v-text="nickName" v-if="nickName" @click="openPersonalCenter"></span>
              ...
              <div class="navbar-cart-container">
                ...
                <div class="navbar-link navbar-cart-link" @click="openCart">
        ...
        <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':loginModalFlag}">
          <div class="md-modal-inner">
            ...
            <div class="register">
              <a @click="openRegister">还没注册？</a>
            </div>
          </div>
        </div>

        <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':loginModalRegisterFlag}">
          <div class="md-modal-inner">
            <div class="md-top">
            ...
            <div class="md-content">
              <div class="confirm-tips">
                <ul>
                  <li class="regi_form_input">
                    <i class="icon IconPeople"></i>
                    <input type="text" tabindex="1" name="loginname" v-model="userRegisterName" class="regi_login_input regi_login_input_left" placeholder="请输入用户名" data-type="loginname">
                  </li>
                  <li class="regi_form_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="password" tabindex="2"  name="password" v-model="userRegisterPwd" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="请输入密码" @keyup.enter="login">
                  </li>
                </ul>
              </div>
              <div class="login-wrap">
        ...
        methods:{
            checkLogin(){
                axios.get("/users/checkLogin").then((response)=>{
                    this.checkLoginData = response.data;
                    var path = this.$route.pathname;
                    if(this.checkLoginData.status==="0"){
//                      this.nickName = res.result;
                      this.$store.commit("updateUserInfo",this.checkLoginData.result);
                      let isType = true;
                      this.$store.commit("updateManagement",isType);
            ...
            openloginModal(){
              this.loginModalRegisterFlag = false
              this.loginModalFlag = true
            },
            // 注册
            openRegister(){
              this.loginModalRegisterFlag = true;
              this.loginModalFlag = false
            },
            register(){
              this.loginModalRegisterFlag = false;
